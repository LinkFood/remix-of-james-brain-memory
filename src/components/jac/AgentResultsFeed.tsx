...
function ResultCard({ task, logs }: { task: AgentTask; logs?: ActivityLogEntry[] }) {
  ...
  return (
    <Card className={`p-4 overflow-hidden transition-all animate-in fade-in-0 slide-in-from-bottom-2 duration-300 ${
      ...
      {/* Brief / Result */}
      {brief && (
        <div className="mt-3 text-sm text-foreground/90 whitespace-pre-wrap break-words leading-relaxed max-h-48 overflow-y-auto">
