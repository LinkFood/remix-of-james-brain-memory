...
import { getFlowAlerts, getDarkPoolRecent, getDarkPool, getNetPremiumTicks, getNope, getGreekFlow, getTopNetImpact, getSweepScreener, WATCHLIST, setUwCaller } from '../_shared/uwClient.ts';
...
serve(async (req) => {
  ...
  setUwCaller('ct-flow-ingester');
  setMcpCaller('ct-flow-ingester');
